      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="nav-item dropdown">
            <a href="/co"><img class="shopping-cart-icon nav-link dropdown-toggle" src="assets/img/shopping_cart.png" alt=""></a>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <form action="{{ url('co') }}/{{ $detail->id }}" method="post">
                                @csrf
                                {{ method_field('DELETE') }}
                                <button type="submit" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-primary danger">Hapus</button>
                              </form>
                            </td>
                        </tr>
                        @endforeach
                        <tr>
                          ...
                          <td>
                            <a href="{{ url('konfirmasi-co') }}" class="btn btn-success">
                              <i><img class="shopping-cart-icon" src="assets/img/shopping_cart.png" alt=""> Check Out</i>
                            </a>
                          </td>
                        </tr>
                    </tbody>
