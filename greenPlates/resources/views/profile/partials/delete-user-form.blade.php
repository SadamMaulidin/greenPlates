<section class="space-y-6">
    <header>
        <h2 class="text-lg font-medium text-black dark:text-gray-100 ml-10">
            {{ __('Delete Account') }}
        </h2>
        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6 ">
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="mt-1 block w-3/4 text-black bg-white"
                    placeholder="{{ __('Password') }}"
                />

                <x-input-error :messages="$errors->userDeletion->get('password')" class="mt-2 text-black bg-white" />
            </div>
